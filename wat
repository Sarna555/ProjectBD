...
public static void AddOrder(string sender, string reciever, date sent, date recieved)
{
...
public static void AddProduct(string idPallet, string name, date bestBefore, string category)
{
	var db = new SQLtoLinqDataContext();
...
public static void UpdateOrder(string orderID, string sender, string reciever, date sent, date recieved)
{
	var db = new SQLtoLinqDataContext();
...
public static void UpdateProduct(string productID, string name, date bestBefore, string category)
{
	var db = new SQLtoLinqDataContext();
